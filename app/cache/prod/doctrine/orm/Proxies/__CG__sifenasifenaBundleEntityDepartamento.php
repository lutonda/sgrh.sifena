 ...
 */
class Departamento extends \sifena\sifenaBundle\Entity\Departamento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Departamento' . "\0" . 'nome', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Departamento' . "\0" . 'descricao', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Departamento' . "\0" . 'id');
        }
