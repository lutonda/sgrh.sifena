 ...
 */
class TabelaSalario extends \sifena\sifenaBundle\Entity\TabelaSalario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\TabelaSalario' . "\0" . 'salario', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\TabelaSalario' . "\0" . 'id', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\TabelaSalario' . "\0" . 'categoria');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TabelaSalario $proxy) {
