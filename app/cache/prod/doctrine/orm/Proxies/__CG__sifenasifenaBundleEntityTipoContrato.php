 ...
 */
class TipoContrato extends \sifena\sifenaBundle\Entity\TipoContrato implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\TipoContrato' . "\0" . 'nome', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\TipoContrato' . "\0" . 'descricao', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\TipoContrato' . "\0" . 'id');
        }
