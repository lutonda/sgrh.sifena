 ...
 */
class Utilizador extends \sifena\sifenaBundle\Entity\Utilizador implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Utilizador' . "\0" . 'id', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Utilizador' . "\0" . 'username', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Utilizador' . "\0" . 'password', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Utilizador' . "\0" . 'email', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Utilizador' . "\0" . 'isActive');
        }
