 ...
 */
class Funcao extends \sifena\sifenaBundle\Entity\Funcao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Funcao' . "\0" . 'nome', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Funcao' . "\0" . 'role', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Funcao' . "\0" . 'id');
        }
