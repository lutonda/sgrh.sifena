 ...
 */
class Sector extends \sifena\sifenaBundle\Entity\Sector implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Sector' . "\0" . 'nome', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Sector' . "\0" . 'descricao', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Sector' . "\0" . 'id', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Sector' . "\0" . 'departamento');
        }
