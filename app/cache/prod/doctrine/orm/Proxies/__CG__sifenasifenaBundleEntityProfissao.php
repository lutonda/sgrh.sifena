 ...
 */
class Profissao extends \sifena\sifenaBundle\Entity\Profissao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Profissao' . "\0" . 'nome', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Profissao' . "\0" . 'descricao', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Profissao' . "\0" . 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Profissao $proxy) {
