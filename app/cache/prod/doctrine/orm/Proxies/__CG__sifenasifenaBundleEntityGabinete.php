 ...
 */
class Gabinete extends \sifena\sifenaBundle\Entity\Gabinete implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Gabinete' . "\0" . 'nome', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Gabinete' . "\0" . 'descricao', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Gabinete' . "\0" . 'id', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Gabinete' . "\0" . 'departamento');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gabinete $proxy) {
