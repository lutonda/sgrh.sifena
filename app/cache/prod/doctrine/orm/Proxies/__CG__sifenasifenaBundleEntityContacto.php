 ...
 */
class Contacto extends \sifena\sifenaBundle\Entity\Contacto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Contacto' . "\0" . 'tipo', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Contacto' . "\0" . 'id');
        }
