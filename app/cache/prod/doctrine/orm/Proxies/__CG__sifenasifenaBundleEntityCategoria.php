 ...
 */
class Categoria extends \sifena\sifenaBundle\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Categoria' . "\0" . 'nome', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Categoria' . "\0" . 'descricao', '' . "\0" . 'sifena\\sifenaBundle\\Entity\\Categoria' . "\0" . 'id');
        }
